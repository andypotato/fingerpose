...
victoryDescription.addDirection(Finger.Index, FingerDirection.VerticalUp, 0.8);
victoryDescription.addDirection(Finger.Index, FingerDirection.DiagonalUpLeft, 1.2);

// middle:
victoryDescription.addCurl(Finger.Middle, FingerCurl.NoCurl, 1.0);
victoryDescription.addDirection(Finger.Middle, FingerDirection.VerticalUp, 1.2);
victoryDescription.addDirection(Finger.Middle, FingerDirection.DiagonalUpLeft, 0.8);
...
victoryDescription.addDirection(Finger.Ring, FingerDirection.DiagonalUpLeft, 0.8);
...
victoryDescription.addDirection(Finger.Pinky, FingerDirection.DiagonalUpLeft, 0.8);
